...
const internalRoles = [
  {
    ...
    permissionSlugs: [
      ...
      'access_control.credentials.update',
      'access_control.operator_sessions.read',
      'access_control.operator_sessions.create',
      'access_control.operator_sessions.update',
      'access_control.overrides.read',
      'access_control.overrides.create',
      'access_control.overrides.update',
      'access_control.decisions.read',
      'access_control.decisions.create',
